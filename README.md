...
| **Cybersecurity** | CompTIA Security+, SOC Lab, Wazuh SIEM, Endpoint Monitoring, Windows/Linux Log Analysis, Sysmon, Alert Triage, Incident Response, OWASP, Secure Coding, JWT |
